...
```
#安装/更新
source <(curl -sL https://raw.githubusercontent.com/oawang/trojan-gfw/master/install.sh)

#卸载
source <(curl -sL https://raw.githubusercontent.com/oawang/trojan-gfw/master/install.sh) --remove
...
更新管理程序: `source <(curl -sL https://raw.githubusercontent.com/oawang/trojan-gfw/master/install.sh)`
